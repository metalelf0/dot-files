return {
	...
	require("user.plugins.colorschemes.base46"),
	require("user.plugins.colorschemes.black-metal"),
	require("user.plugins.colorschemes.catppuccin"),
	require("user.plugins.colorschemes.circadia"),
	require("user.plugins.colorschemes.cendre"),
	require("user.plugins.colorschemes.conifer"),
	require("user.plugins.colorschemes.cursor-dark"),
	require("user.plugins.colorschemes.cursor-light"),
	require("user.plugins.colorschemes.darkbox"),
	require("user.plugins.colorschemes.eldritch"),
	require("user.plugins.colorschemes.ember"),
	require("user.plugins.colorschemes.everforest"),
	require("user.plugins.colorschemes.flexoki"),
	require("user.plugins.colorschemes.flume"),
	require("user.plugins.colorschemes.forsake-repent"),
	...
	require("user.plugins.colorschemes.guts"),
	...
	require("user.plugins.colorschemes.koda"),
	require("user.plugins.colorschemes.lackluster"),
	require("user.plugins.colorschemes.lume"),
	require("user.plugins.colorschemes.luna"),
	require("user.plugins.colorschemes.moonfly"),
	require("user.plugins.colorschemes.nanode"),
	require("user.plugins.colorschemes.national-parks-themes"),
	require("user.plugins.colorschemes.neomodern"),
	require("user.plugins.colorschemes.nightfox"),
	require("user.plugins.colorschemes.nightingale"),
	...
	require("user.plugins.colorschemes.protesilaos"),
