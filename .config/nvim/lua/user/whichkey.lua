...
local mappings = {
  ...
  ["p"] = {
    function() require('telescope.builtin').find_files(require('telescope.themes').get_dropdown{path_display = { truncate = 5 } }) end,
    "Find files",
  },
  ...
  i = {
    name = "Insert",
    e = { function() require'telescope.builtin'.symbols{ sources = {'emoji'} } end, 'Emoji' },
    g = { function() require'telescope.builtin'.symbols{ sources = {'gitmoji'} } end, 'Gitmoji' },
  },
  j = {
    name = "Test",
  ...
  s = {
    ...
    b = { function() require('telescope.builtin').live_grep({grep_open_files = true }) end, "Search in buffers" },
    c = { "<cmd>Telescope colorscheme<cr>", "Colorscheme" },
    f = { function() require('spectre').open_file_search() end, "Search in file" },
    h = { "<cmd>Telescope help_tags<cr>", "Find Help" },
    k = { "<cmd>Telescope keymaps<cr>", "Keymaps" },
    r = { "<cmd>Telescope oldfiles<cr>", "Open Recent File" },
    s = { function() require('spectre').open() end, "Open spectre" },
  },
  t = {
    name = "Terminal",
...
local visualModeMappings = {
  S = {
    name = "Spectre",
    v = { function() require('spectre').open_visual() end, "Open spectre" },
    w = { function() require('spectre').open_visual({select_word=true}) end, "Search word" },
  }
}
