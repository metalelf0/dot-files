require("gruvbox").setup({
	...
	palette_overrides = {
		...
		dark1 = "#00010A",
		-- dark2 = "#504945",
		dark2 = "#282828", -- dark2 is used for completion menus and floats
		-- dark3 = "#665c54",
		dark3 = "#282828", -- dark3 is used for visual selection background
		dark4 = "#7c6f64",
		light0_hard = "#f9f5d7",
		light0 = "#fbf1c7",
		light0_soft = "#f2e5bc",
...
api.nvim_command("hi NotifyERRORBorder " .. set_fg(colors.bright_red))
